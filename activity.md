...
- to create python environment - python -m venv myenv
  -activation of python env -> . myenv/bin/activate
...
exercise -1 chatbot
build a chatbot that recommends a college club based on the students interests

required functionality
1.accepts free text input describing the students interests
2.recommends a specific club by name with one line reason 3. runs in a loop until the user chooses to exits
